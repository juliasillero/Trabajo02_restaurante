...
Se emplean los siguientes criterios y escalas: Precio (€) y Tiempo (min) son criterios de **coste** (menos es mejor). Valoración (0–5), Variedad (1–5), Ruido/ambiente (1–5, donde valores altos significan local más **tranquilo**), Reserva (1–5) y Aparcamiento (1–5) son criterios de **beneficio** (más es mejor).  
Los datos proceden de estimaciones razonables (precios medios y tiempos habituales) y de valoraciones públicas (Google/Maps), ajustadas a una escala común para su comparación multicriterio.
...
En conjunto, el modelo AHP refleja que la elección del restaurante se basa principalmente en ofrecer una **buena experiencia social y gastronómica**, más que en factores puramente económicos o logísticos.
...
Para este criterio (0–5, a mayor mejor) se construyó una matriz de cocientes a partir de las valoraciones medias publicadas en Google Maps. Al ser una matriz perfectamente consistente, el **CR ≈ 0**, por lo que los resultados son totalmente coherentes con los datos observados.
